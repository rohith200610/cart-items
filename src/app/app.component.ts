...
import { CartCardComponent } from './cart/cart.component';
import { Product } from './models/product.model';


@Component({
  selector: 'app-root',
  imports: [RouterOutlet,FormsModule,CommonModule, ProductCardComponent,CartCardComponent],
  ...
  filteredProducts=()=>{
    return this.products.filter(product => {
      if (this.selectedFilter === 'instock') {
        if (product.availabilityStatus !== 'In Stock') return false;
